    ...
    <div className="card p-6 space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="font-bold text-lg text-gray-900 dark:text-white flex items-center gap-2">
            ...
            Greek & International Name Days Directory (Εορτολόγιο)
          </h2>
          <p className="text-xs text-gray-400">Search and browse saint feast days to match with your loved ones</p>
        </div>
        ...
        <div className="relative max-w-sm w-full">
          ...
          <input
            type="text"
            placeholder="Search by name, Greek spelling, or date..."
            value={searchQuery}
      ...
      <div className="space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-gray-100 dark:border-gray-800 pb-2">
          ...
          <div className="flex gap-1 bg-gray-50 dark:bg-gray-900/60 p-1 rounded-xl border border-gray-100 dark:border-gray-800">
            ...
            >
              Matched Recipients ({recipients.filter(r => {
                const recName = r.name.toLowerCase().trim()
      ...
      {paginatedNameDays.length > 0 ? (
                ...
                <div className="pt-3 border-t border-gray-100/80 dark:border-gray-800/80 flex items-center justify-between">
                  {isMatched ? (
                    <div className="flex flex-col">
                      <span className="text-[10px] text-gray-400 uppercase font-medium tracking-wide">For</span>
        ...
        <div className="text-center py-12 text-gray-400">
          ...
          <p className="text-sm">No matching name day occasions found.</p>
        </div>
      )}
      ...
      {totalPages > 1 && (
        <div className="pt-4 flex items-center justify-between border-t border-gray-100 dark:border-gray-800">
          <p className="text-xs text-gray-400">
            ...
            of <span className="font-semibold text-gray-700 dark:text-gray-300">{filteredNameDays.length}</span> entries
          </p>
